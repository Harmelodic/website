...
Most of them are software related.

A link is not an endorsement or indication that I recommend the thing.
...
- [CNCF - Kubernetes Administrator](https://www.cncf.io/certification/cka/)
- [CNCF - Kubernetes Application Developer](https://www.cncf.io/certification/ckad/)
- [Google Cloud Certification](https://cloud.google.com/certification/)
- [Microsoft Azure Certification](https://www.microsoft.com/en-us/learning/azure-exams.aspx)
- [Oracle - Java](https://education.oracle.com/oracle-certification-path/pFamily_48)
...
- [Devoxx](https://www.devoxx.co.uk/)
- [GitHub Universe](https://githubuniverse.com/)
- [GitLab Events](https://about.gitlab.com/events/)
...
- [VoxxedDays](https://events.voxxeddays.com/#/)
...
- [Wayland Window System](https://wayland.freedesktop.org/)
- [X Window System](https://www.x.org/wiki/Documentation/)
...
- [Chrome for Developers](https://developer.chrome.com/home)
- [Discord Developer Portal](https://discord.com/developers/applications)
- [Facebook/Meta for Developers](https://developers.facebook.com/)
- [Firefox Add-ons Developer Hub](https://addons.mozilla.org/en-gb/developers/)
- [Google Developers](https://developers.google.com/)
- [Google Play Developer Console](https://play.google.com/console/developers)
- [IBM Developer](https://developer.ibm.com/)
- [LinkedIn Developer Solutions](https://www.linkedin.com/developers/)
- [Microsoft Developer](https://developer.microsoft.com/)
- [Microsoft Technical Docs](https://learn.microsoft.com/en-gb/docs/)
- [Snap for Developers](https://developers.snap.com/)
- [Spotify for Developers](https://developer.spotify.com/)
- [Twitter/X Developer Docs](https://developer.spotify.com/)
- [Ubuntu Desktop for Developers](https://ubuntu.com/desktop/developers)
...
- [Kroki - Diagrams from Code](https://kroki.io/)
- [Markdown Spec (GitHub Flavored)](https://github.github.com/gfm/)
- [Markdown Spec (Original)](https://daringfireball.net/projects/markdown/)
...
- [swimlanes.io - Sequence Diagrams as Code](https://swimlanes.io/)
...
- [BrowserStack - Browser Testing](https://www.browserstack.com/)
- [Can I Use... - Browser Compatibility](https://caniuse.com/)
- [Chrome Platform Feature Status](https://chromestatus.com/features)
- [Cypress](https://www.cypress.io/)
- [D3 - Data Visualisation](https://d3js.org/)
- [Favicon Generator](https://realfavicongenerator.net/)
- [Geeman's A11y guide](https://geemanjs.github.io/geemans-a11y-guide/)
- [HTML Entities](https://html.spec.whatwg.org/multipage/named-characters.html)
- [Jasmine - BDD Testing](https://jasmine.github.io/)
- [Loqate - Post Address Verification](https://www.loqate.com/en-gb/)
...
- [SinonJS - Test Mocks & Spies](https://sinonjs.org/)
- [Turf.js - Map Graphing](https://turfjs.org/)
...
- [CSS in JS - Technique Comparison](https://github.com/MicheleBertoli/css-in-js)
- [Flexbox - A Complete Guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)
- [Flexbox Overview - MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout)
- [Flexbox learning - Froggy](https://flexboxfroggy.com/)
- [Material UI](https://mui.com/material-ui/getting-started/)
- [Material UI - Icons](https://mui.com/material-ui/material-icons/)
- [Using CSS animations](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_animations/Using_CSS_animations)
- [cssreference.io - Visual CSS Reference](https://cssreference.io/)
- [prefers-color-scheme - MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme)
- [styled-components](https://www.styled-components.com/)

## Game Development

- [AR Core - Google](https://developers.google.com/ar/discover/)
- [C++ Tutorials](https://www.cplusplus.com/doc/tutorial/)
- [Intro to C++ in Unreal Engine](https://docs.unrealengine.com/latest/INT/Programming/Introduction/)
- [Materialize by Bounding Box Software](https://www.boundingboxsoftware.com/materialize/)
- [Phaser - 2D Framework for HTML5](https://github.com/photonstorm/phaser)
- [Stop Killing Games](https://www.stopkillinggames.com)
- [Unity](https://unity.com/)
- [Unreal Engine](https://www.unrealengine.com/)
- [speedtree - Vegetation Modeling](https://store.speedtree.com/)
...
- [IC Graphite Thermal Pad](https://www.innovationcooling.com/products/ic-graphite-thermal-pad/)
...
- [Codecademy - Learning programming](https://www.codecademy.com)
- [Udacity - General Learning](https://www.udacity.com/)
- [Udemy - General Learning](https://www.udemy.com/)
- [egghead.io - Learning modern web development](https://egghead.io)
- [exercism - Learning programming languages](https://exercism.org/)
...
- [Bitbucket - Atlassian](https://www.atlassian.com/software/bitbucket)
